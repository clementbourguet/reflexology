...
<nav aria-label="navigation principale">
    <div class="logo">
        <a href="<?= BASE_URL ?>/">
            <img id="logo" src="<?= BASE_URL ?>/img/logoHD.png" alt="Logo Violette Gilavert Reflexologie">
        </a>

    </div>
    <div class="burger">
        <a id="burger_menu_trigger" href="#">
            <img id="burger_menu" src="<?= BASE_URL ?>/img/burger_menu.png" alt="Logo menu burger">
        </a>
    </div>
    <ul id="mobile_menu" class="main_nav" aria-hidden="true">
        <span id="close_menu">
            <img id="close_icon" src="<?= BASE_URL ?>/img/close_menu.png" alt="icone pour Fermer le menu">
        </span>
        <li>MON PARCOURS</li>
        <li>RÉFLEXOLOGIE</li>
        <li>PRESTATIONS</li>
